...
export function renderLlmsTxt(m, guideText) {
  ...
  return [
    ...
    "",
    "## Vue Components",
    "- Optional Vue 3 layer (`vue/`): in a Vue app, prefer a `Ds*` component for interactive primitives (combobox, dropdown, tree, tabs, dialog, toast, date picker); it wraps the same `.ds-*` classes. See REFERENCE.md.",
    "",
    "## Reference",
